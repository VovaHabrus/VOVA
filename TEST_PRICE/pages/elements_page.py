...
from TEST_PRICE.generator.generator import generated_file, generated_person
from TEST_PRICE.locators.elements_page_locators import *
from QADEMO.pages.base_page import BasePage
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = (
            rf"E:\automation_qa_course\filetest{random.randint(0, 999)}.jpg"
        )
